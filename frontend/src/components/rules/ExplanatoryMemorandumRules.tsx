...
import { explanatoryMemorandumRules } from "../../lib/explanatoryMemorandum";
import { parseItalics, formatRules, groupRules } from "../../lib/formatters";

interface ExplanatoryMemorandumRulesProps {
  activeField: string;
}

export function ExplanatoryMemorandumRules({ activeField }: ExplanatoryMemorandumRulesProps) {
  const rulesMap: Record<string, any> = {
    explanatoryType: explanatoryMemorandumRules.explanatoryType,
    billCitation: explanatoryMemorandumRules.billCitation,
    pinpoint: explanatoryMemorandumRules.pinpoint,
    citationExamples: explanatoryMemorandumRules.citationExamples,
  };
