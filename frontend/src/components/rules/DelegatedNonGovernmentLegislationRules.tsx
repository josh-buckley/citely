...
import { delegatedNonGovernmentLegislationRules } from "../../lib/delegatedNonGovernmentLegislation";
import { parseItalics, formatRules, groupRules } from "../../lib/formatters";
import { RulesTable } from "../ui/rules-table";

interface DelegatedNonGovernmentLegislationRulesProps {
  activeField: string;
}

export function DelegatedNonGovernmentLegislationRules({ activeField }: DelegatedNonGovernmentLegislationRulesProps) {
  const rulesMap: Record<string, any> = {
    issuingBody: delegatedNonGovernmentLegislationRules.issuingBody,
    title: delegatedNonGovernmentLegislationRules.title,
    pinpoint: delegatedNonGovernmentLegislationRules.pinpoint,
    citationExamples: delegatedNonGovernmentLegislationRules.citationExamples,
  };
