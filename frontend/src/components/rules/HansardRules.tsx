...
import { hansardRules } from "../../lib/hansard";
import { parseItalics, formatRules, groupRules } from "../../lib/formatters";
import { RulesTable } from "../ui/rules-table";

interface HansardRulesProps {
  activeField: string;
}

export function HansardRules({ activeField }: HansardRulesProps) {
  const rulesMap: Record<string, any> = {
    jurisdiction: hansardRules.jurisdiction,
    chamber: hansardRules.chamber,
    pinpoint: hansardRules.pinpoint,
    nameOfSpeaker: hansardRules.nameOfSpeaker,
    citationExamples: hansardRules.citationExamples,
  };
